...
<style>
.wrapper-btn-mask {
  background-color: v-bind(edging);
  @apply h-fit pl-[20px] pt-[20px] md:pt-0 md:pb-[20px] rounded-tl-[33px] md:rounded-tl-[0] md:rounded-bl-[33px] md:mt-[-4px] md:mr-[-4px] md:relative absolute right-0 bottom-0
}
...
.btn-mask {
  ...
  @apply flex items-center justify-center w-[48px] h-[48px] md:w-[80px] md:h-[80px] rounded-[16px] md:rounded-[24px] shadow
}
</style>